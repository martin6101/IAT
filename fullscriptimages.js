define(['pipAPI','pipScorer','underscore'], function(APIConstructor, Scorer, _) {
	...
	function stiatExtension(options)
	{
		...
		var stiatObj = 
		{
			...
			[//Each object in this array defines a block
				{
					...
					block : 1, //The block variable is not used later, but could help the user. //20
			...
			instTemplatePractice : '<div style="text-align:center"><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Part blockNum of nBlocks</u><br/><br/></p>' + 
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
